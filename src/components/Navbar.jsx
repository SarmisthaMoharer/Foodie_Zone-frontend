...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] flex mx-auto justify-between items-center p-4 '>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl font-bold italic'>Foodie <span className='font-normal non-italic'>Zone</span></h1>  
        <div className='hidden md:flex space-x-2 text-lg p-1 border border-black rounded-full bg-gray-200'>   
      ...
      <h1 className='text-2xl font-bold italic'>Foodie <span className='font-normal non-italic'>Zone</span></h1> 
      <nav>
